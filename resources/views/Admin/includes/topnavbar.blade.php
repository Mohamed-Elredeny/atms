    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1"> Ahmed Emam
                  <span class="user-name text-bold-700"> {{__('cpanel.welcome')}} </span>
                </span>
                            <span class="avatar avatar-online">
                  <img  style="height: 35px;"    src="{{ asset('Admin/images/logo/logo.png') }}" alt="avatar"><i></i></span>
                        </a>
